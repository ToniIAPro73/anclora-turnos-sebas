...
import { ExtractUsageMetadata, checkGeminiAvailable, parseCalendarWithGemini } from '../../lib/gemini-vision-parser';
            ...
            {!previewUrl ? (
              ...
              >
                ...
                <div style={{ textAlign: 'center' }}>
                  ...
                  <p style={{ fontSize: '0.8rem', opacity: 0.5 }}>El mes y el año se detectan automaticamente al procesar</p>
                </div>
              </div>
            ) : (
